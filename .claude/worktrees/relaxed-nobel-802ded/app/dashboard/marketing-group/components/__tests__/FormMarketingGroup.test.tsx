...
import Form from '../FormMarketingGroup';
import { marketinggroupSchema } from '@/lib/validations/marketinggroup.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = marketinggroupSchema;
const validData = buildValidObject(schema);

describe('FormMarketingGroup', () => {
