...
import Form from '../FormJenisMuatan';
import { jenismuatanSchema } from '@/lib/validations/jenismuatan.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = jenismuatanSchema;
const validData = buildValidObject(schema);

describe('FormJenisMuatan', () => {
