...
import Form from '../FormPenerimaanEmkl';
import { penerimaanemklheaderHeaderSchema } from '@/lib/validations/penerimaanemklheader.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = penerimaanemklheaderHeaderSchema;
const validData = buildValidObject(schema);

describe('FormPenerimaanEmkl', () => {
