...
import Form from '../FormGroupbiayaextra';
import { GroupbiayaextraSchema } from '@/lib/validations/groupbiayaextra.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = GroupbiayaextraSchema;
const validData = buildValidObject(schema);

describe('FormGroupbiayaextra', () => {
