...
import Form from '../FormStatusJobMasukGudang';
import { statusJobHeaderSchema } from '@/lib/validations/statusjob.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = statusJobHeaderSchema;
const validData = buildValidObject(schema);

describe('FormStatusJobMasukGudang', () => {
