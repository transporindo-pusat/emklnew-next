...
import Form from '../FormPengeluaranEmkl';
import { pengeluaranemklheaderHeaderSchema } from '@/lib/validations/pengeluaranemklheader.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = pengeluaranemklheaderHeaderSchema;
const validData = buildValidObject(schema);

describe('FormPengeluaranEmkl', () => {
