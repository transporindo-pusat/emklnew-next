...
import Form from '../FormPengembalianKasGantung';
import { pengembalianKasGantungHeaderSchema } from '@/lib/validations/pengembaliankasgantung.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = pengembalianKasGantungHeaderSchema;
const validData = buildValidObject(schema);

describe('FormPengembalianKasGantung', () => {
