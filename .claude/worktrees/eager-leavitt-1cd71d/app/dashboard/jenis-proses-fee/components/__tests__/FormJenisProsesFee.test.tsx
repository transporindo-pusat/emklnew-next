...
import Form from '../FormJenisProsesFee';
import { jenisprosesfeeSchema } from '@/lib/validations/jenisprosesfee.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = jenisprosesfeeSchema;
const validData = buildValidObject(schema);

describe('FormJenisProsesFee', () => {
