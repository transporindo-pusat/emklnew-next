...
import GridJenisProsesFee from './components/GridJenisProsesFee';
...
const Page = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await fieldLength('jenisprosesfee');
        ...
        console.error('Error fetching data lookup in page:', err);
      }
    };
