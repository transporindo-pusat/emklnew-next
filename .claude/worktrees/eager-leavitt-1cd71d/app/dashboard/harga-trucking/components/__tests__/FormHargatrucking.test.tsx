...
import Form from '../FormHargatrucking';
import { hargatruckingSchema } from '@/lib/validations/hargatrucking.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = hargatruckingSchema;
const validData = buildValidObject(schema);

describe('FormHargatrucking', () => {
