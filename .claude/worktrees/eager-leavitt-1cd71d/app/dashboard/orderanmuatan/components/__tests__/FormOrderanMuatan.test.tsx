...
import Form from '../FormOrderanMuatan';
import { orderanMuatanSchema } from '@/lib/validations/orderanheader.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = orderanMuatanSchema;
const validData = buildValidObject(schema);

describe('FormOrderanMuatan', () => {
