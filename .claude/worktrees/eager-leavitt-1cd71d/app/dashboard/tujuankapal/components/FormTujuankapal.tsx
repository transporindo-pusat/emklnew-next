                    ...
                    <div className="w-full lg:w-[85%]">
                      {lookUpPropsCabang.map((props, index) => (
                        <LookUp
                          ...
                          {...props}
                          lookupValue={(id) =>
                            forms.setValue('cabang_id', id ? String(id) : null)
                          }
                    ...
                    <div className="w-full lg:w-[85%]">
                      {lookUpPropsStatusAktif.map((props, index) => (
                        <LookUp
                          ...
                          {...props}
                          lookupValue={(id) =>
                            forms.setValue('statusaktif', id, { shouldValidate: true })
                          }
                      ...
                      {forms.formState.errors.statusaktif && (
                        <p className="mt-1 text-xs text-destructive">
                          {forms.formState.errors.statusaktif.message as string}
                        </p>
                      )}
                    </div>
                  </div>
...
export default FormTujuanKapal;
