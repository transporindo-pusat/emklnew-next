...
import Form from '../FormMarketingDetail';
import { marketingSchema } from '@/lib/validations/marketing.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = marketingSchema;
const validData = buildValidObject(schema);

describe('FormMarketingDetail', () => {
