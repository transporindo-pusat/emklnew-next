...
import Form from '../FormSandarKapal';
import { sandarkapalSchema } from '@/lib/validations/sandarkapal.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = sandarkapalSchema;
const validData = buildValidObject(schema);

describe('FormSandarKapal', () => {
