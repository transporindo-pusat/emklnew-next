...
import Form from '../FormJurnalUmum';
import { jurnalumumHeaderSchema } from '@/lib/validations/jurnalumum.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = jurnalumumHeaderSchema;
const validData = buildValidObject(schema);

describe('FormJurnalUmum', () => {
