...
import Form from '../FormManagerMarketing';
import { managermarketingHeaderSchema } from '@/lib/validations/managermarketing.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = managermarketingHeaderSchema;
const validData = buildValidObject(schema);

describe('FormManagerMarketing', () => {
