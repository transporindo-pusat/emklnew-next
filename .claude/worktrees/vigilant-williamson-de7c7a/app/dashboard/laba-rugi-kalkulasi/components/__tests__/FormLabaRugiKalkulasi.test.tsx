...
import Form from '../FormLabaRugiKalkulasi';
import { labaRugiKalkulasiSchema } from '@/lib/validations/labarugikalkulasi.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = labaRugiKalkulasiSchema;
const validData = buildValidObject(schema);

describe('FormLabaRugiKalkulasi', () => {
