...
import Form from '../FormMasterbiaya';
import { MasterBiayaSchema } from '@/lib/validations/masterbiaya.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = MasterBiayaSchema;
const validData = buildValidObject(schema);

describe('FormMasterbiaya', () => {
