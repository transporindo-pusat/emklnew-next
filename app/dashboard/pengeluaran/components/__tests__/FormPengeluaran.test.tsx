...
import Form from '../FormPengeluaran';
import { pengeluaranHeaderSchema } from '@/lib/validations/pengeluaran.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = pengeluaranHeaderSchema;
const validData = buildValidObject(schema);

describe('FormPengeluaran', () => {
