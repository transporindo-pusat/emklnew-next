...
import Form from '../FormJenisOrderan';
import { jenisorderanSchema } from '@/lib/validations/jenisorderan.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = jenisorderanSchema;
const validData = buildValidObject(schema);

describe('FormJenisOrderan', () => {
