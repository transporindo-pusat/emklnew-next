...
import Form from '../FormBookingOrderanMuatan';
import { bookingOrderanMuatanSchema } from '@/lib/validations/bookingorderanheader.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = bookingOrderanMuatanSchema;
const validData = buildValidObject(schema);

describe('FormBookingOrderanMuatan', () => {
