...
import Form from '../FormTujuankapal';
import { tujuankapalSchema } from '@/lib/validations/tujuankapal.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = tujuankapalSchema;
const validData = buildValidObject(schema);

describe('FormTujuankapal', () => {
