...
import Form from '../FormPenerimaan';
import { penerimaanHeaderSchema } from '@/lib/validations/penerimaan.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = penerimaanHeaderSchema;
const validData = buildValidObject(schema);

describe('FormPenerimaan', () => {
