...
import Form from '../FormJenisBiayaMarketing';
import { jenisbiayamarketingSchema } from '@/lib/validations/jenisbiayamarketing.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = jenisbiayamarketingSchema;
const validData = buildValidObject(schema);

describe('FormJenisBiayaMarketing', () => {
