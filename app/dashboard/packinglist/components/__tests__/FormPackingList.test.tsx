...
import Form from '../FormPackingList';
import { packinglistHeaderSchema } from '@/lib/validations/packinglist.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = packinglistHeaderSchema;
const validData = buildValidObject(schema);

describe('FormPackingList', () => {
