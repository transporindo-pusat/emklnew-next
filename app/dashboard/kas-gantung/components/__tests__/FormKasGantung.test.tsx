...
import Form from '../FormKasGantung';
import { kasgantungHeaderSchema } from '@/lib/validations/kasgantung.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = kasgantungHeaderSchema;
const validData = buildValidObject(schema);

describe('FormKasGantung', () => {
